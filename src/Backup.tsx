...
// const layouts = Object.keys(breakpoints).reduce((acc, breakpoint) => {
...
const layoutConfig = [
  { i: "item1", x: 0, y: 0, w: 2, h: 2, type: "SocialCardComponent" },
  { i: "item2", x: 1, y: 0, w: 1, h: 1, type: "TipTap" },
  { i: "item3", x: 2, y: 0, w: 1, h: 1, type: "TextComponent" },
  { i: "item4", x: 3, y: 0, w: 1, h: 1, type: "SocialCardComponent" },
];
    ...
    <section className="flex min-h-screen">
      ...
      <section className="min-h-screen flex-1">
        ...
        <GridLayout
          ...
          cols={{ lg: 16, md: 16, sm: 1, xs: 1, xxs: 1 }}
          rowHeight={1200 / 16}
          isDroppable={true}
        ...
        >
          {layout.map((item) => (
            <div
              key={item.i}
              className="border bg-white shadow-md overflow-hidden"
              data-grid={item}
            >
...
// interface LItem extends Layout {
//   type: string;
//   data: unknown;
// }
...
//     data: {
//       title: "Social Card",
//       description: "Some description for the social card component.",
//     },
//   },
//   {
//     i: "item2",
...
//     maxH: 2,
//     type: "TipTap",
//     data: { text: "This is a text component." },
//   },
//   {
//     i: "item4",
//     x: 4,
...
// const lgLayout = layoutConfig.map((item) => ({
//   ...item,
//   w: 2,
//   h: 3,
//   x: 0,
...
// const mdLayout = layoutConfig.map((item) => ({
//   ...item,
//   w: 2,
//   h: 3,
//   x: 0,
...
// const smLayout = layoutConfig.map((item) => ({
//   ...item,
//   w: 2,
//   h: 3,
//   x: 0,
...
//   const onDropHandler = (layout: LItem[], layoutItem: LItem) => {
//     console.log("onDropHandler", layout, layoutItem);
...
//     layoutItem.x = 0;
//     layoutItem.y = Infinity;
//     layoutItem.type = "TextComponent"; // Default component type, change as needed
//     layoutItem.data = { text: "New Item" }; // Default data, change as needed

//     setLayout((prevLayout) => [...prevLayout, layoutItem]);
//   };

//   // console log out the layout in a table format
//   console.log(layout);

//   const renderComponent = (item: LItem) => {
//     const Component = componentRegistry[item.type];
//     if (!Component) return <span className="m-10">Unknown component</span>;
//     return <Component {...item} setIsDraggable={setIsDraggable} />;
//   };

//   console.log(
//     layout.reduce((acc, item) => Math.max(acc, item.x + item.w), 0) * 200
//   );
//   return (
//     <section className="flex min-h-screen">
//       <div className="w-60 bg-slate-50 border-r min-h-screen p-2">
...
//           cols={
//             layout.reduce((acc, item) => Math.max(acc, item.x + item.w), 0) + 1
//           }
...
//             <div
//               key={item.i}
//               className="border bg-white shadow-md rounded-3xl overflow-hidden"
//               data-grid={item}
//             >
//               {renderComponent(item)}
//             </div>
...
//   const onDropHandler = (layout: Layout[], layoutItem: Layout) => {
//     console.log("onDropHandler", layout, layoutItem);
...
//     setLayout((layout) => [...layout, layoutItem]);
//   };
...
//         >
//           {layout.map((item) => (
//             <div key={item.i} className="border bg-white shadow-md rounded-3xl">
//               {/* BASED ON THE ITEM ID, RENDER THE COMPONENT*/}
//               {item.i === "item1" ? (
//                 <TipTap setIsDraggable={setIsDraggable} />
//               ) : (
//                 <span className="m-10">{item.i}</span>
//               )}
//             </div>
//           ))}
//         </GridLayout>
